		...
		<div class="banner-text text-center text-white">
			<div class="container">
				<div class="row justify-content-center">
					<h3 class="fs-1 mb-3 fw-bold fst-italic" style="font-family: 'Nothing You Could Do', cursive;">Khách sạn</h3>
	...
	<div class="main" style = "min-height: 70vh;">
		<div class="container">
			...
			<div class="row">
				...
				$count = 6;
				$sql_total_page = 'select count(HotelID) as number from hotel';
				...
				$sql = 'select * from hotel limit '.$first_index.','.$count ;
